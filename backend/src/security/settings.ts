...
export const FEATURES: FeatureDef[] = [
  ...
  { id: 'docker_monitoring', label: 'Docker Monitoring', description: 'Container host metrics', group: 'infrastructure', supported: true, defaultEnabled: true },
  ...
  { id: 'uptime_kuma_integration', label: 'Uptime Kuma Integration', description: 'Status page ingestion', group: 'integrations', supported: true, defaultEnabled: true },
  { id: 'telegram_notifications', label: 'Telegram Notifications', description: 'Send alerts to Telegram', group: 'notifications', supported: true, defaultEnabled: true },
  { id: 'email_notifications', label: 'Email Notifications', description: 'Send alerts via SMTP (unsupported yet)', group: 'notifications', supported: true, defaultEnabled: false },
  ...
  { id: 'wall_display_mode', label: 'Wall Display Mode', description: 'Kiosk-friendly read-only wall display', group: 'platform', supported: true, defaultEnabled: false },
