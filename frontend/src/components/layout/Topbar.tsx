...
import { Bell, LogIn, LogOut, Search, Settings, Wifi, WifiOff, CheckCheck } from 'lucide-react';
...
export function Topbar() {
  ...
  return (
    <header className="relative z-20 flex h-16 shrink-0 items-center justify-between gap-4 border-b border-surface-border bg-base/70 px-6 backdrop-blur-xl">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="text-right">
          ...
          <div className="hidden text-[10px] uppercase tracking-widest text-text-muted sm:block">
            {formatDate(now)}
          </div>
        </div>
        ...
        {authStatus === 'anonymous' ? (
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              title="Sign out"
              className="flex h-10 w-10 items-center justify-center rounded-xl border border-surface-border bg-surface text-text-secondary transition-colors hover:border-crit/40 hover:text-crit cursor-pointer"
            >
        ...
        <div className="relative" ref={panelRef}>
          <button
            ...
            className="relative flex h-10 w-10 items-center justify-center rounded-xl border border-surface-border bg-surface text-text-secondary transition-colors hover:border-accent/40 hover:text-text-primary cursor-pointer"
          >
          ...
          <AnimatePresence>
            {panelOpen && (
              <motion.div
                ...
                className="absolute right-0 top-12 w-[380px] overflow-hidden rounded-2xl border border-surface-border bg-surface-elevated shadow-card"
              >
